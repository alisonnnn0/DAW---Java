...
public class Ex3 {
    ...
    public static void main(String[] args) {
        ...
        try (Formatter f = new Formatter("vendes.txt")){
            
            f.format("%-52s %-10s %-10s %-10s %-10s%n", "Producte","1 Trim", "2 Trim","3 Trim", "4 Trim");
            f.format("%-52s %-10s %-10s %-10s %-10s%n", "--------", "------", "------", "------","------");
            
            for (int i = 0; i < nomProductes.length; i++) {
                
                f.format("%-52s %-10d %-10d %-10d %-10d%n", nomProductes[i], vendesTrim[i][0], vendesTrim[i][1], vendesTrim[i][2], vendesTrim[i][3]);
            }
