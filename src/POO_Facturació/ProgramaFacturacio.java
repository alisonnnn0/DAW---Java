...
//        LiniaFactura linia1 = new LiniaFactura(1, factura1, producte1, 2); // 2 unitats de Producte A
//        LiniaFactura linia2 = new LiniaFactura(2, factura1, producte2, 3); // 3 unitats de Producte B
//
...
//
//        // Mostrar la factura
//        System.out.println("Factura número: " + factura1.getNumeroFactura());
//        
...
//
//        for (LiniaFactura linia : factura1.getLinies()) {
